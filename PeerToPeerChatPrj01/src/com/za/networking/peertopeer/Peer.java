...
public class Peer {
	public static void main(String[] args) throws Exception {
	    ...
	    ServerThead serverThread = new ServerThead(setupValues[1]);
		serverThread.start();
		new Peer().updateListenToPeers(bufferedReader, setupValues[0], serverThread);
	}

    public void updateListenToPeers(BufferedReader bufferedReader, String username, ServerThead serverThread) throws Exception {
     ...
     public void communicate(BufferedReader bufferedReader, String username, ServerThead serverThread) {
    	try {
